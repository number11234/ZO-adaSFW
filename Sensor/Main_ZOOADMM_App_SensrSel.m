...
%         eps_track_ZO_adaSFW(:,j) = eps_track_ZO_adaSFW_tmp; %% 保存不同传感器下的变量
%         obj_track_ZO_adaSFW(:,j) = obj_track_ZO_adaSFW_tmp;
%         
%         [x_sel_ZO_adaSFW, mse_ZO_adaSFW ]= mse_SenSel(A_allT, x_ave_track_ZO_adaSFW(:,end) ,  options.ksel ) ; % 计算 mse
%         
%         mse_track_ZO_adaSFW(j) = mse_ZO_adaSFW;         %保存mse
