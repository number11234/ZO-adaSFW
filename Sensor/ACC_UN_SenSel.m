function [x_ave_track, eps_track, obj_track,obj_track_50] = ACC_UN_SenSel(options)
...
for t = 1 :IterMax    %% 总迭代次数
    ...
    if t > 1
            ...
            if mod(t,50) == 0    %% 每50打印一次信息
               disp(sprintf('ACC_un for iter = %d with xeps = %4.5f, obj = %4.5f',...
